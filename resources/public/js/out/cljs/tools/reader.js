...
var G__34577 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__34577;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__34578 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__34578,ch);
...
if(("\\" === ch__$1)){
var ch_34579__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_34579__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_34579__$2);
} else {
}

var G__34580 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__34580;
continue;
}
}
...
var G__34591 = cljs.core.conj_BANG_.call(null,a,form);
a = G__34591;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__34592 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__34593 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__34593;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__34592;
}});
/**
...
var vec__34597 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__34597,(0),null);
var end_column = cljs.core.nth.call(null,vec__34597,(1),null);
...
var sb = (function (){var G__34612 = (new goog.string.StringBuffer());
G__34612.append(initch);
...
var G__34614 = (function (){var G__34613 = sb;
G__34613.append(ch);

return G__34613;
})();
var G__34615 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__34614;
ch = G__34615;
continue;
}
...
switch (G__34618) {
case "\\":
var G__34622 = (function (){var G__34619 = sb;
G__34619.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__34619;
})();
var G__34623 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__34622;
ch = G__34623;
continue;
...
break;
default:
var G__34624 = (function (){var G__34620 = sb;
G__34620.append(ch);

return G__34620;
})();
var G__34625 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__34624;
ch = G__34625;
continue;
...
var vec__34626 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__34626,(0),null);
var end_column = cljs.core.nth.call(null,vec__34626,(1),null);
...
var vec__34629 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__34629,(0),null);
var column = cljs.core.nth.call(null,vec__34629,(1),null);
...
var vec__34634 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__34634,(0),null);
var column = cljs.core.nth.call(null,vec__34634,(1),null);
...
var vec__34639 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__34639,(0),null);
var column = cljs.core.nth.call(null,vec__34639,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__34644 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__34644,(0),null);
var start_column = cljs.core.nth.call(null,vec__34644,(1),null);
...
var vec__34647 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__34647,(0),null);
var end_column = cljs.core.nth.call(null,vec__34647,(1),null);
...
var G__34650 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__34650,true,null,opts,pending_forms);
...
var G__34651 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__34651)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__34651)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__34651)){
...
var _STAR_suppress_read_STAR__orig_val__34652 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__34653 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__34653;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__34652;
}});
...
var G__34654 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__34654,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__34654,rdr,first_line);
...
var G__34658 = matched;
var G__34659 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__34658;
finished = G__34659;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__34660 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__34661 = (function (){var or__4047__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__34661;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__34660;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__34662 = cljs.tools.reader.arg_env;
var arg_env_temp_val__34663 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__34663;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__34664 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__34664,"(");
...
var G__34665 = (i + (1));
var G__34666 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4047__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__34662;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__34667 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__34667);
...
var G__34668 = cljs.core.next.call(null,s__$1);
var G__34669 = ret;
s__$1 = G__34668;
r = G__34669;
continue;
...
var G__34670 = cljs.core.next.call(null,s);
var G__34671 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__34670;
key_vals = G__34671;
continue;
} else {
...
var gensym_env_orig_val__34675 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__34676 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__34676;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__34675;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__34677 = token;
var G__34677__$1 = (((G__34677 == null))?null:cljs.core.subs.call(null,G__34677,(1)));
var G__34677__$2 = (((G__34677__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__34677__$1));
var G__34677__$3 = (((G__34677__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__34677__$2));
var G__34677__$4 = (((G__34677__$3 == null))?null:cljs.core.symbol.call(null,G__34677__$3));
if((G__34677__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__34677__$4);
}
})():(function (){var G__34678 = token;
var G__34678__$1 = (((G__34678 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__34678));
if((G__34678__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__34678__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__34689,reader){
...
var opts = map__34690__$1;
var eof = cljs.core.get.call(null,map__34690__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4641__auto___34698 = arguments.length;
var i__4642__auto___34699 = (0);
while(true){
if((i__4642__auto___34699 < len__4641__auto___34698)){
args__4647__auto__.push((arguments[i__4642__auto___34699]));

var G__34700 = (i__4642__auto___34699 + (1));
i__4642__auto___34699 = G__34700;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq34696){
var G__34697 = cljs.core.first.call(null,seq34696);
var seq34696__$1 = cljs.core.next.call(null,seq34696);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34697,seq34696__$1);
});

...
var G__28031 = devtools.prefs.pref.call(null,v);
v = G__28031;
continue;
} else {
return v;
...
}catch (e28034){var _e__27048__auto__ = e28034;
return false;
}})();
...
}catch (e28038){var _e__27048__auto__ = e28038;
return false;
}})();
...
}catch (e28040){var _e__27048__auto__ = e28040;
return false;
}}
}
});
...
var vec__28042 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__28042,(0),null);
var name = cljs.core.nth.call(null,vec__28042,(1),null);
...
return cljs.core.some.call(null,(function (p1__28045_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28045_SHARP_);
}),template);
});

...
var o27929 = temp__5718__auto__;
var temp__5718__auto____$1 = (o27929["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o27930 = temp__5718__auto____$1;
return (o27930["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__27041__auto___27933 = t;
(o__27041__auto___27933["cljs$lang$ctorPrWriter"]).call(o__27041__auto___27933,t,writer);
}catch (e27932){var __27934 = e27932;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27935 = num_code;
switch (G__27935) {
case (1):
return (185);
...
}catch (e27937){var _e__27048__auto__ = e27937;
return false;
}})())){
...
var vec__27938 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27938,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o27941 = temp__5718__auto__;
var temp__5718__auto____$1 = (o27941["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o27942 = temp__5718__auto____$1;
return (o27942["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4641__auto___27949 = arguments.length;
var i__4642__auto___27950 = (0);
while(true){
if((i__4642__auto___27950 < len__4641__auto___27949)){
args__4647__auto__.push((arguments[i__4642__auto___27950]));

var G__27951 = (i__4642__auto___27950 + (1));
i__4642__auto___27950 = G__27951;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27945){
var vec__27946 = p__27945;
var ns_detector = cljs.core.nth.call(null,vec__27946,(0),null);
...
var G__27952 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27953 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27952;
remaining_tokens = G__27953;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27943){
var G__27944 = cljs.core.first.call(null,seq27943);
var seq27943__$1 = cljs.core.next.call(null,seq27943);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27944,seq27943__$1);
});
...
var vec__27957 = cljs.core.split_with.call(null,(function (p1__27956_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27956_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27957,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27957,(1),null);
...
var vec__27960 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27960,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27960,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27963 = cljs.core.rest.call(null,remaining_tokens);
var G__27964 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27963;
name_tokens = G__27964;
continue;
} else {
...
var vec__27967 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27967,(0),null);
var arity = cljs.core.nth.call(null,vec__27967,(1),null);
var vec__27970 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27970,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27970,(1),null);
var vec__27973 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27973,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27973,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27973,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27973,(3),null);
...
var vec__27979 = result;
var munged_ns = cljs.core.nth.call(null,vec__27979,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27979,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27979,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27979,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27979,(4),null);
var arity = cljs.core.nth.call(null,vec__27979,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__27983 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__27983,(0),null);
var args = cljs.core.nth.call(null,vec__27983,(1),null);
var vec__27986 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27986,(0),null);
var name = cljs.core.nth.call(null,vec__27986,(1),null);
...
var G__27989 = (arity + (1));
var G__27990 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27991){
var vec__27992 = p__27991;
var arity = cljs.core.nth.call(null,vec__27992,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27992,(1),null);
...
return cljs.core.get.call(null,arities,p1__27995_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__27996_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27999){
var vec__28000 = p__27999;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__28000,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27997){
var G__27998 = cljs.core.first.call(null,seq27997);
var seq27997__$1 = cljs.core.next.call(null,seq27997);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27998,seq27997__$1);
});
...
var map__28008 = options;
var map__28008__$1 = (((((!((map__28008 == null))))?(((((map__28008.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28008.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__28008):map__28008);
var include_ns_QMARK_ = cljs.core.get.call(null,map__28008__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__28008__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__28008__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__28008__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28009 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__28009,(0),null);
var fn_name = cljs.core.nth.call(null,vec__28009,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__28009,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__28009,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__28009,(4),null);
var arity = cljs.core.nth.call(null,vec__28009,(5),null);
...
}catch (e28013){var _e__27048__auto__ = e28013;
...
var G__28014 = (obj[cljs.core.first.call(null,path)]);
var G__28015 = cljs.core.rest.call(null,path);
obj = G__28014;
path = G__28015;
continue;
} else {
...
return (function (accum,p__28016){
var vec__28017 = p__28016;
var bit = cljs.core.nth.call(null,vec__28017,(0),null);
var protocol = cljs.core.nth.call(null,vec__28017,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28020){
var vec__28021 = p__28020;
var ns = cljs.core.nth.call(null,vec__28021,(0),null);
var name = cljs.core.nth.call(null,vec__28021,(1),null);
var selector = cljs.core.nth.call(null,vec__28021,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__28026,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__28026,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__28026,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__28024_SHARP_){
return (obj[cljs.core.first.call(null,p1__28024_SHARP_)]);
});})(name,sorted_matches,vec__28026,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);

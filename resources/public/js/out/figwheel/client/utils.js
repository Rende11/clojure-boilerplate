...
return (new CustomEvent(event_name,(function (){var obj36071 = {"detail":data};
return obj36071;
})()));
} else {
...
var f = (function (){var pred__36078 = cljs.core._EQ_;
var expr__36079 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__36078.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__36079))){
return ((function (pred__36078,expr__36079){
return (function (p1__36072_SHARP_){
return console.warn(p1__36072_SHARP_);
});
;})(pred__36078,expr__36079))
} else {
if(cljs.core.truth_(pred__36078.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__36079))){
return ((function (pred__36078,expr__36079){
return (function (p1__36073_SHARP_){
return console.debug(p1__36073_SHARP_);
});
;})(pred__36078,expr__36079))
} else {
if(cljs.core.truth_(pred__36078.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__36079))){
return ((function (pred__36078,expr__36079){
return (function (p1__36074_SHARP_){
return console.error(p1__36074_SHARP_);
});
;})(pred__36078,expr__36079))
} else {
return ((function (pred__36078,expr__36079){
return (function (p1__36075_SHARP_){
return console.log(p1__36075_SHARP_);
});
;})(pred__36078,expr__36079))
}
}
...
var eval_fn = cljs.core.get.call(null,map__36083__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__36085_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__36087,(0),null);

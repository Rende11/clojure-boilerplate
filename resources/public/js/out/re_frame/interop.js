...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__27012 = cljs.core.instance_QMARK_;
var expr__27013 = reactive_val;
if(cljs.core.truth_(pred__27012.call(null,reagent.ratom.RAtom,expr__27013))){
return "ra";
} else {
if(cljs.core.truth_(pred__27012.call(null,reagent.ratom.RCursor,expr__27013))){
return "rc";
} else {
if(cljs.core.truth_(pred__27012.call(null,reagent.ratom.Reaction,expr__27013))){
return "rx";
} else {
if(cljs.core.truth_(pred__27012.call(null,reagent.ratom.Track,expr__27013))){
return "tr";
} else {
return "other";
}

...
return cljs.core.swap_BANG_.call(null,re_frisk.data.re_frame_events,cljs.core.conj,cljs.core.assoc.call(null,(function (){var or__4047__auto__ = cntx;
...
var len__4641__auto___35995 = arguments.length;
var i__4642__auto___35996 = (0);
while(true){
if((i__4642__auto___35996 < len__4641__auto___35995)){
args__4647__auto__.push((arguments[i__4642__auto___35996]));

var G__35997 = (i__4642__auto___35996 + (1));
i__4642__auto___35996 = G__35997;
continue;
} else {
}
break;
...
return cljs.core.reset_BANG_.call(null,new cljs.core.Keyword(null,"id-handler","id-handler",1013135509).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,re_frisk.data.re_frame_data)),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p1__35992_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([cljs.core.first.call(null,p1__35992_SHARP_)],[cljs.core.deref.call(null,cljs.core.second.call(null,p1__35992_SHARP_))]);
}),cljs.core.remove.call(null,(function (p1__35993_SHARP_){
return ((cljs.core._EQ_.call(null,cljs.core.first.call(null,cljs.core.ffirst.call(null,p1__35993_SHARP_)),new cljs.core.Keyword("re-frisk.core","db","re-frisk.core/db",447694709))) || ((cljs.core.second.call(null,p1__35993_SHARP_) == null)));
...
/** @this {Function} */
re_frisk.core.re_frame_sub.cljs$lang$applyTo = (function (seq35994){
var self__4629__auto__ = this;
return self__4629__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq35994));
});
...
var args__4647__auto__ = [];
var len__4641__auto___36003 = arguments.length;
var i__4642__auto___36004 = (0);
while(true){
if((i__4642__auto___36004 < len__4641__auto___36003)){
args__4647__auto__.push((arguments[i__4642__auto___36004]));

var G__36005 = (i__4642__auto___36004 + (1));
i__4642__auto___36004 = G__36005;
continue;
} else {
}
break;
...
re_frisk.core.enable_re_frisk_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (p__35999){
var vec__36000 = p__35999;
var opts = cljs.core.nth.call(null,vec__36000,(0),null);
...
re_frame.core.reg_sub.call(null,new cljs.core.Keyword("re-frisk.core","db","re-frisk.core/db",447694709),((function (vec__36000,opts){
return (function (db,_){
return db;
});})(vec__36000,opts))
);
} else {
re_frame.core.register_sub.call(null,new cljs.core.Keyword("re-frisk.core","db","re-frisk.core/db",447694709),((function (vec__36000,opts){
return (function (db,_){
return reagent.ratom.make_reaction.call(null,((function (vec__36000,opts){
return (function (){
...
/** @this {Function} */
re_frisk.core.enable_re_frisk_BANG_.cljs$lang$applyTo = (function (seq35998){
var self__4629__auto__ = this;
return self__4629__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq35998));
});

re_frisk.core.enable_frisk_BANG_ = (function re_frisk$core$enable_frisk_BANG_(var_args){
var args__4647__auto__ = [];
var len__4641__auto___36007 = arguments.length;
var i__4642__auto___36008 = (0);
while(true){
if((i__4642__auto___36008 < len__4641__auto___36007)){
args__4647__auto__.push((arguments[i__4642__auto___36008]));

var G__36009 = (i__4642__auto___36008 + (1));
i__4642__auto___36008 = G__36009;
continue;
} else {
}
break;
...
/** @this {Function} */
re_frisk.core.enable_frisk_BANG_.cljs$lang$applyTo = (function (seq36006){
var self__4629__auto__ = this;
return self__4629__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq36006));
});
...
cljs.core.swap_BANG_.call(null,re_frisk.data.re_frame_data,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"views","views",1450155487),view,new cljs.core.Keyword(null,"subs","subs",-186681991)], null),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p1__36010_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([p1__36010_SHARP_],[re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__36010_SHARP_], null))]);
}),subs)));

var seq__36011 = cljs.core.seq.call(null,subs);
var chunk__36012 = null;
var count__36013 = (0);
var i__36014 = (0);
while(true){
if((i__36014 < count__36013)){
var s = cljs.core._nth.call(null,chunk__36012,i__36014);
...
var G__36015 = seq__36011;
var G__36016 = chunk__36012;
var G__36017 = count__36013;
var G__36018 = (i__36014 + (1));
seq__36011 = G__36015;
chunk__36012 = G__36016;
count__36013 = G__36017;
i__36014 = G__36018;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__36011);
if(temp__5720__auto__){
var seq__36011__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__36011__$1)){
var c__4461__auto__ = cljs.core.chunk_first.call(null,seq__36011__$1);
var G__36019 = cljs.core.chunk_rest.call(null,seq__36011__$1);
var G__36020 = c__4461__auto__;
var G__36021 = cljs.core.count.call(null,c__4461__auto__);
var G__36022 = (0);
seq__36011 = G__36019;
chunk__36012 = G__36020;
count__36013 = G__36021;
i__36014 = G__36022;
continue;
} else {
var s = cljs.core.first.call(null,seq__36011__$1);
cljs.core.swap_BANG_.call(null,re_frisk.data.re_frame_data,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"subs","subs",-186681991),s], null),re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [s], null)));


var G__36023 = cljs.core.next.call(null,seq__36011__$1);
var G__36024 = null;
var G__36025 = (0);
var G__36026 = (0);
seq__36011 = G__36023;
chunk__36012 = G__36024;
count__36013 = G__36025;
i__36014 = G__36026;
continue;
}
} else {
...
})().call(null,new cljs.core.Keyword("re-frisk","update-db","re-frisk/update-db",-658524246),(function (_,p__36027){
var vec__36028 = p__36027;
var ___$1 = cljs.core.nth.call(null,vec__36028,(0),null);
var value = cljs.core.nth.call(null,vec__36028,(1),null);
return value;
}));

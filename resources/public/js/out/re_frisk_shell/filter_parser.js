...
var G__34703 = cljs.tools.reader.reader_types.peek_char.call(null,rdr);
if(cljs.core._EQ_.call(null,null,G__34703)){
...
var vec__34704 = clojure.string.split.call(null,s,/\s+/,(2));
var prefix = cljs.core.nth.call(null,vec__34704,(0),null);
var rest = cljs.core.nth.call(null,vec__34704,(1),null);
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"val","val",128701612),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"free","free",801364328),prefix], null),new cljs.core.Keyword(null,"rest","rest",-1241696419),(function (){var or__4047__auto__ = rest;
...
try{var map__34708 = re_frisk_shell.filter_parser.read_string_SINGLEQUOTE_.call(null,s);
...
var foo = map__34708__$1;
var val = cljs.core.get.call(null,map__34708__$1,new cljs.core.Keyword(null,"val","val",128701612));
var rest = cljs.core.get.call(null,map__34708__$1,new cljs.core.Keyword(null,"rest","rest",-1241696419));
...
try{var map__34714 = re_frisk_shell.filter_parser.read_string_SINGLEQUOTE_.call(null,s);
...
var val = cljs.core.get.call(null,map__34714__$1,new cljs.core.Keyword(null,"val","val",128701612));
var rest = cljs.core.get.call(null,map__34714__$1,new cljs.core.Keyword(null,"rest","rest",-1241696419));
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"val","val",128701612),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"expr","expr",745722291),val], null),new cljs.core.Keyword(null,"rest","rest",-1241696419),rest], null);
}catch (e34710){var _ = e34710;
var vec__34711 = clojure.string.split.call(null,s,/\s+/,(2));
var prefix = cljs.core.nth.call(null,vec__34711,(0),null);
var rest = cljs.core.nth.call(null,vec__34711,(1),null);
var prefix__$1 = clojure.string.replace.call(null,prefix,/^\"/,"");
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"val","val",128701612),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"string-prefix","string-prefix",2091851734),prefix__$1], null),new cljs.core.Keyword(null,"rest","rest",-1241696419),(function (){var or__4047__auto__ = rest;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
return "";
...
var G__34716 = cljs.core.first.call(null,s);
switch (G__34716) {
case "[":
case "(":
case "{":
...
var map__34718 = re_frisk_shell.filter_parser.parse_part.call(null,s__$2);
...
var val = cljs.core.get.call(null,map__34718__$1,new cljs.core.Keyword(null,"val","val",128701612));
var rest = cljs.core.get.call(null,map__34718__$1,new cljs.core.Keyword(null,"rest","rest",-1241696419));
